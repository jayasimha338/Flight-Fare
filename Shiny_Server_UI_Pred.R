...
airlines_dom <- read.csv("D:/EXCELR 2ND PROJECT//FinalDomesticDataset.csv")
str(airlines_dom)
...
airlines_international <- read.csv("D:/EXCELR 2ND PROJECT//FinalInternationalDataset.csv")
...
ui<- fluidPage(
    ...
    titlePanel(title= h2(tags$b("FLIGHT FARE FORECAST"), align="center", style='background-color:#4682B4;',style='font-style: italic;')),
    br(),
    br(),
    sidebarLayout(sidebarPanel(  h4("HELLO! WELCOME", style = "color: white;"),
                                 br(),
                                 br(),
